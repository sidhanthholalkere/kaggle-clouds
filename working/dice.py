...
class NewDiceCallback(MetricCallback):
    """
...
class MulticlassDiceMetricCallback(Callback):
    ...
    def on_loader_end(self, state: RunnerState):
        ...
        batch_metrics = calculate_dice(**tp_fp_fn_dict)
...
def newdice(
    ...
    Returns:
        double:  Dice score
    """
    activation_fn = catalyst.utils.get_activation_fn(activation)
    outputs = activation_fn(outputs)


    outputs = resize_like(outputs, targets)
